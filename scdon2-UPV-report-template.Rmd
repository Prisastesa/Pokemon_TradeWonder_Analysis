...
## Les caractéristiques statistiques d’un Pokémon (puissance, rareté, type) influencent-elles sa probabilité d’être échangé dans le système Wonder Trade de Pokémon Sun and Moon?
...
Sarah Guilleminot : Étudiante n°22405827, Resp. de la collecte des données.

Sara Fenina : Étudiante n°22411291, Resp. recherche bases de données.

Ambinintsoa Rakoto: Étudiante n°22402951, Resp. Descriptif des tables.

Stephanie Sbircea: Étudiante n°22304694, Resp. import des données.
...
| abilities        | Chaîne (texte) | Capacités spéciales du Pokémon                  | Liste de capacités (ex : Overgrow, Blaze…) |
| against_bug      | Réel           | Multiplicateur de dégâts contre le type Insecte | 0.5 = résistant, 1 = neutre, 2 = faible    |
| against_dark     | Réel           | Multiplicateur contre type Ténèbres             | Même logique (0.5, 1, 2…)                  |
| against_dragon   | Réel           | Multiplicateur contre type Dragon               | Idem                                       |
| against_electric | Réel           | Multiplicateur contre type Électrique           | Idem                                       |
| against_fairy    | Réel           | Multiplicateur contre type Fée                  | Idem                                       |
| against_fight    | Réel           | Multiplicateur contre type Combat               | Idem                                       |
| against_fire     | Réel           | Multiplicateur contre type Feu                  | Idem                                       |
| against_flying   | Réel           | Multiplicateur contre type Vol                  | Idem                                       |
| against_ghost    | Réel           | Multiplicateur contre type Spectre              | Idem                                       |
| against_grass    | Réel           | Multiplicateur contre type Plante               | Idem                                       |
| against_ground   | Réel           | Multiplicateur contre type Sol                  | Idem                                       |
| against_ice      | Réel           | Multiplicateur contre type Glace                | Idem                                       |
| against_normal   | Réel           | Multiplicateur contre type Normal               | Idem                                       |
| against_poison   | Réel           | Multiplicateur contre type Poison               | Idem                                       |
| against_psychic  | Réel           | Multiplicateur contre type Psy                  | Idem                                       |
| against_rock     | Réel           | Multiplicateur contre type Roche                | Idem                                       |
| against_steel    | Réel           | Multiplicateur contre type Acier                | Idem                                       |
| against_water    | Réel           | Multiplicateur contre type Eau                  | Idem                                       |
       |      |               |                 |

| name           | Chaîne           | Nom du Pokémon            | Ex : Bulbasaur, Charmander    |
| pokedex_number | Entier           | Numéro dans le Pokédex    | Identifiant unique            |
| type1          | Chaîne           | Type principal            | Ex : Grass, Fire              |
| type2          | Chaîne           | Type secondaire           | Peut être vide                |
| height_m       | Réel             | Taille en mètres          | Valeur numérique              |
| weight_kg      | Réel             | Poids en kg               | Valeur numérique              |
| generation     | Entier           | Génération du Pokémon     | 1 à 7 (ou plus selon dataset) |
| is_legendary   | Entier (booléen) | Pokémon légendaire ou non | 0 = non, 1 = oui              |

| attack      | Entier | Attaque du Pokémon | Valeur numérique (plus élevé = plus puissant physiquement) |
| defense     | Entier | Défense            | Résistance aux attaques physiques                          |
| sp_attack   | Entier | Attaque spéciale   | Puissance des attaques spéciales                           |
| sp_defense  | Entier | Défense spéciale   | Résistance aux attaques spéciales                          |
| speed       | Entier | Vitesse            | Détermine l’ordre d’attaque                                |
| hp          | Entier | Points de vie      | Santé du Pokémon                                           |
| base_total  | Entier | Total des stats    | Somme des statistiques                                     |

| ----------------- | ------ | -------------------------------- | ------------------------ |
| capture_rate      | Entier | Facilité de capture              | Plus élevé = plus facile |
| experience_growth | Chaîne | Type de progression              | Ex : slow, medium, fast  |
| base_egg_steps    | Entier | Nombre de pas pour éclore un œuf | Plus élevé = plus long   |
...
### MCD
  ...
  ![**Figure 1 MCD**.](tuto-0019(1).png){#uml width="15cm" height="9cm"}

### MOD :

  ![**Figure 2.1 MOD.**](pokewonder (1).png){#uml width="18cm" height="30cm"}
 ...
 POKEMON (pokedex_number, name, type1, type2, hp, attack, defense, sp_attack, sp_defense, speed, base_total, capture_rate, is_legendary, generation)

TRADE (id_trade, date_trade, time_trade, trainer_region, trainer_subregion, pokemon_region, level, level_met, gender, nature, pokeball, held_item, perfect_ivs, #pokedex_number)
...
![**Figure 3 Normalisation des nom de pokemon**.](normalisation.png){#uml width="15cm" height="9cm"}
