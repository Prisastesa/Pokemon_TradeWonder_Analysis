...
\bigskip
On a sélectionné  la table pokémon car elle contient les données relatif au description d'un pokémon et la table wonder trade car elle contient les informations concernant les échanges.
 Les données sont stockées sous formats csv . Le fichier pockemon.csv  (38 colonnes et 802 lignes)  et le fichier wonder trade (15 colonnes et 501 lignes) 
\bigskip
...
## Modèles MCD et MOD
  ...
  ![Relations.](tuto-0019(1).pdf){#uml width="8cm" height="4cm"}
